...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://ang2:ang2023@172.174.219.228:3306/db2'
db2 = SQLAlchemy(app)
...
def index():
    counties = sorted(df_copd['LocationName'].unique())
...
def create_plot(county):
    ...
    selected_county_avg = df_copd[df_copd['LocationName'] == county]['Data_Value'].mean()
